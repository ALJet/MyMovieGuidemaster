...
import indi.aljet.mymovieguide_master.listing.MoviesListingPresenter;

/**
 * Created by PC-LJL on 2018/4/11.
 */

public class SortingDialogFragment extends
        DialogFragment implements SortingDialogView ,
    ...
    public static SortingDialogFragment newInstance
        ...
        SortingDialogFragment.moviesListingPresenter =
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ).getListingComponent().inject(this);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View dialogView = inflater.inflate(R.layout
