...
public class MoviesListingFragment extends
        Fragment implements MoviesListingView {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        .fragment_movies,container,false);
    ...
    private void displaySortingOptions(){
        DialogFragment sortingDialogFragment =
                SortingDialogFragment.newInstance(moviesListingPresenter);
        sortingDialogFragment.show(getFragmentManager(),
                "Select Quantity");
    }
    ...
    private void initLayoutReferences(){
        ...
        if(getResources().getConfiguration().orientation ==
            ...
            columns = getResources().getInteger(R.integer
            .no_of_columns);
        }
    ...
    public void loadingStarted() {
        Snackbar.make(moviesListing,R.string
        .loading_movies,Snackbar.LENGTH_SHORT).show();
    }

    @Override
    public void loadingFailed(String errorMessage) {
        Snackbar.make(moviesListing,errorMessage,
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putParcelableArrayList(Constants.MOVIE,
