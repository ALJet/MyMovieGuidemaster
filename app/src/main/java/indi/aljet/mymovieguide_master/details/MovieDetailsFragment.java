...
import indi.aljet.mymovieguide_master.Api;
import indi.aljet.mymovieguide_master.BaseApplication;
...
public class MovieDetailsFragment extends Fragment
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ((BaseApplication) getActivity().getApplication())
                .createDetailsComponent().inject(this);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        .fragment_movie_details,container,false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if(getArguments() != null){
            Movie movie = (Movie) getArguments()
                    .get(Constants.MOVIE);
            if(movie != null){
                this.movie = movie;
    ...
    private void setToolbar(){
        ...
        .colorPrimaryDark));
        collapsingToolbar.setTitle(getString(R.string
        .movie_details));
        collapsingToolbar.setCollapsedTitleTextAppearance(R.style
        .CollapsedToolbar);
    ...
    public void showDetails(Movie movie) {
        Glide.with(getContext())
                .load(Api.getBackdropPath(movie
                .getBackdropPath())).into(poster);
        releaseDate.setText(String.format(getString(R
    ...
    public void showTrailers(List<Video> trailers) {
        if(trailers.isEmpty()){
            ...
            for(Video trailer : trailers){
                View thumbContainer = inflater
                        .inflate(R.layout.video,this.trailers,false);
                ImageView thumbView = ButterKnife
                        .findById(thumbContainer,R.id.video_thumb);
                thumbView.setTag(R.id.glide_tag,Video
                .getUrl(trailer));
        ...
        if(reviews.isEmpty()){
            ...
            for(Review review : reviews){
                ViewGroup reviewContainer = (ViewGroup)
                        inflater.inflate(R.layout.review,
                                reviewsContainer,false);
                TextView reviewAuthor = ButterKnife
                        .findById(reviewContainer,R.id.review_author);
    ...
    public void showFavorited() {
        favorite.setImageDrawable(ContextCompat.getDrawable
                (getContext(),R.drawable.ic_favorite_white_24dp));
    }


    @Override
    public void showUnFavorited() {
        favorite.setImageDrawable(ContextCompat
    ...
    private void onThumbnailClick(View view){
        ...
        Intent playVideoIntent = new Intent(Intent
        .ACTION_VIEW, Uri.parse(videoUrl));
